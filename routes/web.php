...
Route::get("/editInvoice/{invoice_id}","App\Http\Controllers\InvoiceController@editData");
Route::get("/deleteInvoice/{invoice_id}","App\Http\Controllers\InvoiceController@deleteData");
